    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">نظرسنجی سیستم آموزش</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <form action="{{route('user.educationForms.update',$education->id)}}" method="POST">
                                @csrf
                                @method('PATCH')
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    @foreach($education->form()->questions as $q)
                                        <tr>
                                            <td>{{$q->question}}</td>
                                            <td>
