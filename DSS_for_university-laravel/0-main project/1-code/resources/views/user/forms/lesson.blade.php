    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">نظرسنجی اساتید</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        {{$lesson->name}} - استاد {{$lesson->master->first()->name}}
                    </div>
                    <div class="card-body">
                        <div class="container">

                            <form action="{{route('user.lessonForms.update',$lesson->id)}}" method="POST">
                                @csrf
                                @method('PATCH')
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    @foreach($lesson->form()->questions as $q)
                                        <tr>
                                            <td>{{$q->question}}</td>
                                            <td>
