...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        auth()->user()->posts()->create($validatedData);// should not use this code --->  $post = Post::create($validatedData); because here just call Post so user that login  not consider
